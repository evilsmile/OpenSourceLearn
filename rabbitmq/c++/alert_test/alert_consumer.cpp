...
void single_queue_init(amqp_connection_state_t& conn, const std::string& queue_name, const std::string& route_name)
{
    ...
    amqp_queue_bind(conn,
                    ...
                    amqp_cstring_bytes(ALERT_EXCHANGE.c_str()),
...
void rabbit_init(amqp_connection_state_t& conn)
{
    ...
    amqp_exchange_declare(conn, /* state */
                          ...
                          amqp_cstring_bytes(ALERT_EXCHANGE_TYPE.c_str()),  /* type */
                          0,          /* passive */
                          1,          /* durable */
                          0,          /* auto_delete */
                          0,    /* internal */
    ...
    single_queue_init(conn, CRITICAL_QUEUE, CRITICAL_ROUTER);
    single_queue_init(conn, RATING_QUEUE, RATING_ROUTER);
}
